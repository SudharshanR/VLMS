		...
		if (null == objUser) {
			...
			if (null != request.getParameter("updateBtn")) {
				if (AppUtils.md5(request.getParameter("pass")).equals(
					...
					objUpdateUser.setLastName(request.getParameter("lastname"));
					objUpdateUser.setEmail(objUser.getEmail());

					if (AppUtils.md5(request.getParameter("pass")).equals(
							AppUtils.md5(request.getParameter("newpass"))) || "".equalsIgnoreCase(request.getParameter("newpass")))
						objUpdateUser.setPassword(null);
					else
						objUpdateUser.setPassword(AppUtils.md5(request
								.getParameter("newpass")));

					objUpdateUser.setAddress(request.getParameter("address"));
					...
					if (!request.getParameter("membertype").equalsIgnoreCase(
